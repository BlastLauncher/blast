...
values, and event routing. Capability tests cover brokered clipboard writes
and reads, denied-write errors, and unconfigured context errors. Unmeasured
surface (shortcuts, richer Form controls, and unsupported action children)
raises structured compatibility errors.
