...
const PROP_WHITELIST: Record<SceneNodeType, readonly string[]> = {
  ...
  "list-empty-view": ["icon", "iconTintColor", "title", "description"],
  "list-dropdown": [
    "id",
    "tooltip",
    "placeholder",
  ...
  "list-dropdown-item": ["value", "title", "icon", "iconTintColor", "keywords"],
  ...
  "grid-dropdown-item": ["value", "title", "icon", "iconTintColor", "keywords"],
  "grid-dropdown-section": ["title"],
  "menu-bar-extra": ["title", "tooltip", "icon", "iconTintColor", "isLoading"],
  "menu-bar-item": ["title", "subtitle", "tooltip", "icon", "iconTintColor", "shortcut", "onAction", "isAlternate"],
  "menu-bar-section": ["title"],
  "menu-bar-submenu": ["title", "icon", "iconTintColor"],
  "menu-bar-separator": [],
  action: ["id", "title", "onAction", "icon", "iconTintColor", "shortcut", "style", "autoFocus"],
  detail: ["markdown", "navigationTitle", "isLoading"],
  "detail-metadata": [],
  "detail-metadata-label": ["title", "icon", "iconTintColor", "text", "textColor"],
  "detail-metadata-separator": [],
  "detail-metadata-link": ["title", "target", "text"],
  "detail-metadata-tag-list": ["title"],
  "detail-metadata-tag-list-item": ["icon", "iconTintColor", "text", "color", "onAction"],
  "action-group": [
    "id",
    "title",
    "icon",
...
const PROP_TYPES: Record<SceneNodeType, Readonly<Record<string, ScenePropType>>> = {
  ...
  "list-empty-view": { icon: "string", iconTintColor: "string", title: "string", description: "string" },
  "list-dropdown": {
    id: "string",
    tooltip: "string",
    placeholder: "string",
  ...
  "grid-empty-view": { icon: "string", iconTintColor: "string", title: "string", description: "string" },
  "grid-dropdown": {
    id: "string",
    tooltip: "string",
    placeholder: "string",
  ...
  "menu-bar-submenu": { title: "string", icon: "string", iconTintColor: "string" },
  "menu-bar-separator": {},
  action: {
    id: "string",
    title: "string",
