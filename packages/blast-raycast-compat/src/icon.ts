/**
 * Built-in Raycast icon identifiers.
 *
 * The official enum is mirrored from the pinned Raycast API declaration.
 * Legacy names from older Raycast releases remain available where they are
 * still present in the public extension corpus.
 */
export const Icon = {
 ...
 * iconTintColor properties. Pink and Brown remain as legacy raw aliases
 * because older corpus extensions still reference them.
 */
export const Color = {
  Red: "raycast-red",
  Blue: "raycast-blue",
